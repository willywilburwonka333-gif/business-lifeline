...
const tutorialSteps: Record<TutorialId, TutorialStep[]> = {
  ...
  lifeline: [
    ...
    { title: "Cashflow and Accuracy Boost", body: "Complete the optional 13-week forecast to find the first likely cash shortfall, then test recovery changes before acting.", target: '.area-tool-list button:nth-child(4)' },
  ...
  operating: [
    ...
    { title: "Finance and provider control", body: "Use Business Lifeline's native ledger and documents while keeping external providers replaceable.", target: '.area-tool-list button:nth-child(4)' },
