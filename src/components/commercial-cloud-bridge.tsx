...
const SOURCES = ["business-lifeline-operating-platform-v1", "business-lifeline-live-control-v1", "business-lifeline-native-finance-v1", "business-lifeline-advanced-accounting-v1", "business-lifeline-commercial-finance-controls-v1", "business-lifeline-document-vault-v1"] as const;
